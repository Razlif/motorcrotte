...
runing_sound = pygame.mixer.Sound("sounds/running.mp3")
pygame.mixer.Sound.set_volume(runing_sound, 0.8)

breaking_sound = pygame.mixer.Sound("sounds/break.mp3")
pygame.mixer.Sound.set_volume(breaking_sound, 0.3)

horn_sound = pygame.mixer.Sound("sounds/horn_sound.mp3")
pygame.mixer.Sound.set_volume(horn_sound, 0.3)

shoot_sound = pygame.mixer.Sound("sounds/poop.mp3")
pygame.mixer.Sound.set_volume(shoot_sound, 0.5)

hit_sound = pygame.mixer.Sound("sounds/oh_no.mp3")
